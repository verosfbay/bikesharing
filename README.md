...
## Purpose
The purpose of this visualization is to convince investors that a bike-sharing program in Des Moines is a solid business proposal. To solidify the proposal, one of the key stakeholders would like to see a bike trip analysis. I will analyze the data using Tableau Public. 
...
<img width="974" alt="Screen Shot 2022-06-25 at 4 55 54 PM" src="https://user-images.githubusercontent.com/95447175/175793997-bcec0334-799c-4daf-b9f7-979a7679c445.png">
The "Checkout Times for Users" graph shows that, on average, most users checkout bikes for a period of 5 minutes.

<img width="995" alt="Screen Shot 2022-06-25 at 4 56 24 PM" src="https://user-images.githubusercontent.com/95447175/175794013-3e9d208a-8a49-4aae-b40b-4c4df3e06658.png">
...
## Summary
The results showed that the most popular starting station and the most popular ending station are the same. There is not a big difference in checkout times as it relates to gender. The most popular day and time for bike trips is Thursday between 5-6pm. Monday and Tuesday 5-6pm follow in second. Looking at the subscribers, males take a lot more trips than female subscribers, Thursday being the most popular day for them, and Friday following in second. 

The two additonal visualizations I would suggest for future analysis are: Customer Type, to see the ratio of customers to subscribers, and Bike Utilization, to see which bikes are being used most often and may be in need of repairs. Customer Type would allow stakeholders to plan their marketing activities in regards to target users, and Bike Utilization would allow stakeholders to keep an eye on the most popular bikes, to make sure they don't break down before they need to be repaired or replaced. 
